...
public class Date
{
    ...
    private int month;
    private int day;
    private Map<Integer, Integer> monthCode = new HashMap<Integer, Integer>(); // KEY is month number, VALUE is month code.
    private Map<Integer, String> dayCode = new HashMap<Integer, String>(); // KEY is day code, VALUE is day.
    ...
    public String getDayOfTheWeek()
    {
        ...
        if (ca.bcit.comp1451.lab2a.lindsay.alex.Date.isLeapYear(this.year))
        {
